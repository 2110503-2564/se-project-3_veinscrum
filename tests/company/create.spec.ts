...
test("Create Company as Company user", async ({ page }) => {
  ...
  // Verify the dropdown menu contains the "Create Company" option
  await expect(page.getByRole('menuitem', { name: 'Create Company' })).toBeVisible();
  ...
  // Click on "Create Company" to navigate to the company creation form
  await page.getByRole('menuitem', { name: 'Create Company' }).click();

  // Confirm the heading "Create Company" is visible on the form page
  ...
  await page.getByRole('textbox', { name: 'Company Name' }).fill('Mock Company');
  ...
  await page.getByRole('textbox', { name: 'Website' }).fill('https://www.google.com/');
  ...
  await page.getByRole('textbox', { name: 'editable markdown' }).fill('Test Create Company');
  ...
  await expect(page.getByRole('heading', { name: 'Mock Company' })).toBeVisible();
